...
public class BmiRecord {
    ...
    public double getChiSoBMI() { return chiSoBMI; }
    public void setChiSoBMI(double chiSoBMI) { this.chiSoBMI = chiSoBMI; }
    public String getNgayDo() { return ngayDo; }
    public void setNgayDo(String ngayDo) { this.ngayDo = ngayDo; }
}
